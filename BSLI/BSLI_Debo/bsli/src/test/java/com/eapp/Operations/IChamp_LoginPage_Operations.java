...
IChamp_HomePage homepage = new IChamp_HomePage();
	...
	public void IChamp_Login(WebDriver driver) throws IOException, InterruptedException {
		...
		//new WebDriverWait(driver, 300).until(ExpectedConditions.invisibilityOfElementLocated(By.xpath(IChamp_LoginPage.Progress)));
		//Thread.sleep(1000);
		//	wait.until(ExpectedConditions.elementToBeClickable(By.xpath(IChamp_LoginPage.Uname)));
		//	wait.until(ExpectedConditions.elementToBeClickable(By.xpath(IChamp_LoginPage.Pwd)));
			//Thread.sleep(2000);
